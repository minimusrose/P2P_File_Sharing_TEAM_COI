...
print(f"OK Peers ajoutes: {len(peers)}")
for p in peers:
...
print(f"OK Fichiers ajoutes: {len(files)}")
for f in files:
...
print(f"OK Chunks ajoutes: {len(chunks)}")
for c in chunks:
...
print(f"OK Fichiers partages localement: {len(local)}")
print()
